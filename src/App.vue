  ...
  <div class="shell-app">
    ...
    <footer class="footer-status">
      <div class="status-item">
        <span class="dot active"></span> HOST (5000)
      </div>
      <div class="status-item">
        <span class="dot active"></span> UI Module (5003)
      </div>
      <div class="status-item">
        <span class="dot active"></span> Remote Master (5001)
      </div>
      <div class="status-item">
        <span class="dot active"></span> Remote Sales (5002)
      </div>
    </footer>
  </div>
</template>
